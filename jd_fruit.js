const $ = new Env('东东农场');
let cookiesArr = [], cookie = '', jdFruitShareArr = [], notify, newShareCodes;
// 助力好友分享码(最多4个,否则后面的助力失败),原因:京东农场每人每天只有四次助力机会
// 此此内容是IOS用户下载脚本到本地使用，填写互助码的地方，同一京东账号的好友互助码请使用@符号隔开。
// 下面给出两个账号的填写示例（iOS只支持2个京东账号）
let shareCodes = [
  // 账号一的好友shareCode,不同好友的shareCode中间用@符号隔开
  '43ba5595842644dbaef827b5c695903d@32513d6e605b426d8f85af33425e1d3a@6fa35224635241649624f87c7dbcf48f@5fa47502990d497e8ffc52f6d50a2f49@346c1c0651264c4f8b478a230e9cb43e@22c5066a0c1349179152c5dd81157522@d059c3a404ce44b8837d4496b70390c6',
