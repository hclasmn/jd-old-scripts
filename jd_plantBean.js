...
let cookiesArr = [], cookie = '', jdPlantBeanShareArr = [], notify, newShareCodes, option, message, subTitle;
// 京东接口地址
...
let shareCodes = [
  ...
  'nq7oddlndhtxy2t2a3krm3pgd43h7wlwy7o5jii@e7lhibzb3zek25ysxwbohv2la62zmmkgounn47a@3dteasqk7i6ojk5elxts3bgykm@jdj576n3d7iimpvqshnw2xn5jwzzx5bjas34ohi@ltoft2n2vjxwvujnxwy5yttkau5ac3f4ijdgqji@olmijoxgmjutzg2ptr37i7g5l47qcoiafep7zei@olmijoxgmjutzuzzkxt3fb4xwh2hejsrodetcui',
...
function requireConfig() {
  return new Promise(resolve => {
    ...
    if ($.isNode()) {
      jdPlantBeanShareArr = shareCodes;
    } else {
