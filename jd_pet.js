const $ = new Env('东东萌宠');
let cookiesArr = [], cookie = '', jdPetShareArr = [], notify, newShareCodes;
// 助力好友分享码(最多5个,否则后面的助力失败),原因:京东农场每人每天只有四次助力机会
// 此此内容是IOS用户下载脚本到本地使用，填写互助码的地方，同一京东账号的好友互助码请使用@符号隔开。
// 下面给出两个账号的填写示例（iOS只支持2个京东账号）
let shareCodes = [
  // 账号一的好友shareCode,不同好友的shareCode中间用@符号隔开
  'MTAxODc2NTEzMDAwMDAwMDAxODY1NzA0MQ==@MTAxODc2NTEzMzAwMDAwMDAyNjgzMjA3Nw==@MTE1NDQ5MzYwMDAwMDAwMzYxMzQ5MzU=@MTE1NDAxNzgwMDAwMDAwMzYwNDE3NjM==@MTE1NDAxNzYwMDAwMDAwMzYwNDIyMjc=@MTE1NDUwMTI0MDAwMDAwMDM5NzAzNzM1@MTAxODc2NTEzMDAwMDAwMDAxMTAxNTgwNQ==',
